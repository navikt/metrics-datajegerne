...
def run_etl_tema():
    ...
    df = pandas_gbq.read_gbq("SELECT * FROM `teamdatajegerne-prod-c8b1.landing_zone.etterlevelse_krav`", "teamdatajegerne-prod-c8b1", progress_bar_type=None)
    ...
    # Må koble på tema og
    df_2 = pandas_gbq.read_gbq("SELECT distinct code as regelverk, tema, underavdeling FROM `teamdatajegerne-prod-c8b1.landing_zone.etterlevelse_tema`", "teamdatajegerne-prod-c8b1", progress_bar_type=None)
