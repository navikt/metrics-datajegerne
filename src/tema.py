...
def run_etl_tema():
    ...
    df = pandas_gbq.read_gbq("SELECT * FROM `teamdatajegerne-prod-c8b1.metrics.raw_krav`", "teamdatajegerne-prod-c8b1")
    ...
    # Må koble på tema og
    df_2 = pandas_gbq.read_gbq("SELECT distinct code as regelverk, tema, underavdeling FROM `teamdatajegerne-prod-c8b1.metrics.raw_tema`", "teamdatajegerne-prod-c8b1")
