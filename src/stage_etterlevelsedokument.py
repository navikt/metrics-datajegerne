...
def run_etl_dokumenter():
    ...
    cols_to_keep = ["id", "title", "etterlevelseNummer", "teams", "irrelevansFor", "avdeling", "varslingsadresser", "behandlingIds", "beskrivelse", "prioritertKravNummer", "risikoeiere", "forGjenbruk", "gjenbrukBeskrivelse", "tilgjengeligForGjenbruk", "resources", "nomAvdelingId", "avdelingNavn", "seksjoner"]
    ...
    df["dokumentSistOppdatert"] = df.groupby(["etterlevelseDokumentasjonId"])["time"].transform("max")
    df["aktivRad"] = False
